...
$css =
'<link rel="stylesheet" href="%PUBURLPATH%/%SYSTEMWEB%/ClassificationPlugin/styles.css" media="all" />';
...
sub initPlugin {
    ...
    Foswiki::Func::registerTagHandler(
        ...
        sub {
            initCore();
            return
              Foswiki::Plugins::ClassificationPlugin::Core::handleHIERARCHY(@_);
        }
    );
    ...
    Foswiki::Func::registerTagHandler(
        ...
        sub {
            initCore();
            return Foswiki::Plugins::ClassificationPlugin::Core::handleSUBSUMES(
                @_);
        }
    );
    ...
    Foswiki::Func::registerTagHandler(
        ...
        sub {
            initCore();
            return
              Foswiki::Plugins::ClassificationPlugin::Core::handleSIMILARTOPICS(
                @_);
        }
    );
    ...
    Foswiki::Func::registerTagHandler(
        ...
        sub {
            initCore();
            return Foswiki::Plugins::ClassificationPlugin::Core::handleCATINFO(
                @_);
        }
    );
    ...
    Foswiki::Func::registerTagHandler(
        ...
        sub {
            initCore();
            return Foswiki::Plugins::ClassificationPlugin::Core::handleTAGINFO(
                @_);
        }
    );
    ...
    Foswiki::Func::registerTagHandler(
        ...
        sub {
            initCore();
            return Foswiki::Plugins::ClassificationPlugin::Core::handleDISTANCE(
                @_);
        }
    );
    ...
    Foswiki::Func::registerRESTHandler(
        ...
        sub {
            initServices();
            return Foswiki::Plugins::ClassificationPlugin::Services::splitFacet(
                @_);
        }
    );
    ...
    Foswiki::Func::registerRESTHandler(
        ...
        sub {
            initServices();
            return Foswiki::Plugins::ClassificationPlugin::Services::renameTag(
                @_);
        }
    );
    ...
    Foswiki::Func::registerRESTHandler(
        ...
        sub {
            initServices();
            return
              Foswiki::Plugins::ClassificationPlugin::Services::normalizeTags(
                @_);
        }
    );
    ...
    Foswiki::Func::addToZone( 'head', 'CLASSIFICATIONPLUGIN', $css,
...
sub indexAttachmentHandler {
    initCore();
    return Foswiki::Plugins::ClassificationPlugin::Core::indexAttachmentHandler(
        @_);
}
...
sub initServices {
    ...
    Foswiki::Plugins::ClassificationPlugin::Services::init( $baseWeb,
        $baseTopic );
}
